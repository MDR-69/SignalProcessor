...
If you want to use the binary data output by Strobot in other custom projects, you can just take the SignalMessages files and include them in your projects - Java, C++ and Python are currently supported